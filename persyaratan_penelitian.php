...
<div class="sidebar">
    ...
    <div class="content">
        ...
        <ul>
            <li>1.Surat pengantar dari Perguruan Tinggi/Surat Permohonan yang ditujukan kepada: Kepala Pusat Pendidikan dan Pelatihan Setjen  DPR RI</li>
        ...
        <!-- Tombol Next -->
        <a href="form_penelitian.php" class="next-button">Next</a>
