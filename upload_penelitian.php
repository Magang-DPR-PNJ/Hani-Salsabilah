...
<div class="sidebar">
    ...
    <a href="persyaratan_penelitian.php">Dokumen Persyaratan</a>
    <img src="person1.png" alt="Person">
    <a href="form_penelitian.php">Biodata</a>
...
<div class="container">
    <h2>Upload Dokumen Penelitian</h2>

    <form action="upload.php" method="POST" enctype="multipart/form-data">
        <?php
        // Array untuk menyimpan judul form upload dan input name masing-masing
        $documents = [
            "Surat Pengantar/ Permohonan dari Universitas/Sekolah/Lembaga" => "surat_pengantar",
            "Proposal Penelitian" => "krs",
            "Daftar Wawancara/Kuesioner Penelitian" => "nilai",
        ...
        <div class="form-group">
            <input type="submit" value="Submit Dokumen">
        </div>
    </form>

    <a href="status_penelitian.php" class="next-button">Next</a>
