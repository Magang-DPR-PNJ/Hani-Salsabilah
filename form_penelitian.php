...
<div class="sidebar">
    ...
    <a href="form_penelitian.php" class="active">Biodata</a>
...
<div class="container">
    <h2>Pendaftaran Penelitian (Biodata)</h2>
    <form action="proses_pendaftaran.php" method="post" class="form-container">
        ...
        <div class="form-group">
            ...
            <input type="text" id="metode_penelitian" name="metode_penelitian" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="bagian_pkl">Bagian Pengajuan Penelitian:</label>
    ...
    <div class="form-group">
        <a href="upload_penelitian.php" class="next-button">Next</a>
    </div>
</div>
