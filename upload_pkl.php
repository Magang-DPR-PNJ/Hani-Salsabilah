...
<div class="container">
    <h2>Upload Dokumen PKL</h2>

    <form action="upload.php" method="POST" enctype="multipart/form-data">
        <?php
        // Array untuk menyimpan judul form upload dan input name masing-masing
        $documents = [
            "Surat Pengantar dari Sekolah" => "surat_pengantar",
            "Curriculum Vitae (Daftar Riwayat Hidup)" => "cv",
            "Pas Foto Berlatar Merah" => "pas_foto",
            "Kartu Pelajar/KTP" => "ktp"
        ];
    ...
    <a href="status_pkl.php" class="next-button">Next</a>
</div>
