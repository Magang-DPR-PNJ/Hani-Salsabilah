...
<div class="sidebar">
    ...
    <div class="content">
        ...
        <ul>
            <li>Surat pengantar dari Universitas yang ditujukan kepada: Kepala Pusat Pendidikan dan Pelatihan Setjen DPR RI (berisi tentang tujuan magang, dan pemilihan topik magang);</li>
        ...
        <!-- Tombol Next -->
        <a href="form_magang.php" class="next-button">Next</a>
    </div>
</body>
</html>
